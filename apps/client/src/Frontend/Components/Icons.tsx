...
import { DarkForestIcon, IconType as DFIconType } from '@darkforest_eth/ui';
...
export const IconType = DFIconType;
export type IconType = import('@darkforest_eth/ui').IconType;
