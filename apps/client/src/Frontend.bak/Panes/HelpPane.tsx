    ...
    <ModalPane id={ModalName.Help} title='Help' visible={visible} onClose={onClose}>
      <HelpContent>
        ...
        <Section>
          ...
          <EmSpacer height={1} /> Some planets contain <White>Artifacts</White> - Aztec-native NFTs
          that can be traded with other players. Artifacts can be harvested and deposited onto
          planets, buffing their stats.
        </Section>
