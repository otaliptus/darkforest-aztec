...
export function NetworkHealthPane() {
  return (
    <>
      <White>Tx Speed: </White>For each auto fee setting (which you can choose in the{' '}
      ...
      settings), which is aggregated into this network health indicator.
    </>
  );
}
...
export function TwitterHandleTooltipPane() {
  return (
    <>
      Twitter linking is not available in Aztec mode.
    </>
  );
}
...
export function ModalTwitterVerificationTooltipPane() {
  return <>Twitter linking is not available in Aztec mode.</>;
}
