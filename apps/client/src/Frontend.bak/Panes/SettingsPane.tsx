import type { EthConnection } from '@darkforest_eth/network';
      ...
      <SettingsContent>
        ...
        {!isAztec && (
          <Section>
            ...
            price means your transactions will be prioritized by the blockchain, making them
            confirm faster. We recommend using the auto average setting. All auto settings prices
            are pulled from an oracle and are capped at 15 gwei.
            <Spacer height={16} />
            <MultiSelectSetting
              wide
              uiManager={uiManager}
        ...
        <Section>
          <SectionHeader>Account Info (Private)</SectionHeader>
          {isAztec ? (
            <>
              Private keys are managed by the Aztec node. Your home coordinates still matter for
              recovery on a new device.
            </>
          ) : (
            <>
              Your secret key, together with your home planet's coordinates, grant you access to
              your Dark Forest account on different browsers. You should save this info somewhere on
              your computer.
            </>
          )}
          <Spacer height={16} />
        ...
        <Section>
          <SectionHeader>Node Connection</SectionHeader>
          <Spacer height={8} />
          Current Node URL: {rpcUrl}
          <Spacer height={8} />
          <TextInput
            value={rpcUrl}
            onChange={(e: Event & React.ChangeEvent<DarkForestTextInput>) =>
        ...
        <Section>
          ...
          We collect a minimal set of data and statistics such as proving times and average
          transaction times, to help us optimize performance and fix bugs. This does not include
          personal data like email or IP address.
          <Spacer height={8} />
          <BooleanSetting
            uiManager={uiManager}
        ...
        <Section>
          ...
          Toggle high-detail logs for gameplay actions. Logs are written as NDJSON and can be tailed
