# Ticket 001 - Repo analysis + grant plan
...
- Call out any mismatch between the expected repo map (packages/contracts, apps/client, packages/shared) and the current layout.

## Out of Scope
- No code changes beyond documentation/planning.
